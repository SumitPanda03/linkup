...
const UpdateGroupChatModal = ({ fetchAgain, setFetchAgain, fetchMessage }) => {
    ...
    const handleRename = async () => {
        ...
        try {
            ...
            const { data } = await axios.put(
                `https://linkup-backend-4h8c.onrender.com/api/chat/rename`,
                {
    ...
    const handleSearch = async (query) => {
        ...
        try {
            ...
            const { data } = await axios.get(
                `https://linkup-backend-4h8c.onrender.com/api/user?search=${search}`,
                config
            );
            console.log(data);
            setLoading(false);
    ...
    const handleAddUser = async (user1) => {
        try {
            ...
            const response = await axios.put(
                `https://linkup-backend-4h8c.onrender.com/api/chat/groupadd`,
                {
                    chatId: selectedChat._id,
                    userId: user1._id,
                },
    ...
    const handleRemove = async (user1) => {
        ...
        try {
            ...
            const response = await axios.put(
                `https://linkup-backend-4h8c.onrender.com/chat/groupremove`,
                {
                    chatId: selectedChat._id,
                    userId: user1._id,
                },
